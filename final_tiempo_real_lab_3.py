...
para_nombre_csv = nombre_archivo + ".csv"
para_nombre_imagen = nombre_archivo + ".jpg"
...
def update_data(i):
    if not pausa:
        ...
        time.sleep(1)
        plt.savefig(para_nombre_imagen)
        ###
...
intento = open("opciones.csv", "a")
#intento.write("\n")
intento.write(nombre_archivo+ "\n")
intento.close()
