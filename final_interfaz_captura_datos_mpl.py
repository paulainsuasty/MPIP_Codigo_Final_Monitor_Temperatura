...
class Ui_interfaz_captura_datos(object):
    def setupUi(self, interfaz_captura_datos):
        ...
        self.input_num_datos.setGeometry(QtCore.QRect(170, 140, 50, 20))
        ...
        self.boton_volver.setGeometry(QtCore.QRect(560, 300, 75, 23))
    ...
    def para_grafica_limitada(self):
        ...
        num_data_adquisicion = self.input_num_datos.text()
        num_data_adquisicion = int(num_data_adquisicion)
        print(num_data_adquisicion)
